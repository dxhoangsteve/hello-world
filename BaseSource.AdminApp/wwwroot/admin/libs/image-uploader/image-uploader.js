...
(function ($) {
    ...
    $.fn.imageUploader = function (options) {
        ...
        let defaults = {
            preloaded: [],
            imagesInputName: 'ImageFileList',
            preloadedInputName: 'preloaded',
            label: 'Click để upload hình ảnh',
            extensions: ['.jpg', '.jpeg', '.png', '.gif', '.svg'/*, '.mp4', '.mov'*/],
            mimes: ['image/jpeg', 'image/png', 'image/gif', 'image/svg+xml'/*, "video/mp4", "video/quicktime"*/],
            maxSize: undefined,
            maxFiles: undefined,
        };
        ...
        let createContainer = function () {
            ...
            let $uploadedContainer = $('<div>', { class: 'uploaded' }).appendTo($container),
                ...
                $i = $('<i>', { class: 'far fa-cloud-arrow-up' }).appendTo($textContainer),
        ...
        let createImg = function (src, id, preloaded) {
            ...
            let $container = $('<div>', { class: 'uploaded-image' }),
                ...
                $i = $('<i>', { class: 'far fa-times' }).appendTo($button);
